...
import { useState, useReducer, useEffect, useLayoutEffect, useRef } from './hooks';
...
const React = { useState, useReducer, useEffect, useLayoutEffect, useRef, createElement, Component,  PureComponent, createRef, forwardRef, memo };
